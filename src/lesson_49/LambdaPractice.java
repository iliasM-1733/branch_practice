...
public class LambdaPractice {
    ...
    public static void exampleOfAbstractClasses() {
        ...
        // myQueue - анонимный класс. Это выражается в том, что объект myQueue -
        // является объектом интерфейса Queue, но тк мы не можем использовать интерфейсы без реализации,
        // в данном примере был использован прием с реализацией через "анонимный класс". Это актуально, когда
        ...
        // такая реализация называется "анонимный классом". Самая частая реализация - объекты Runnable и Executable.
